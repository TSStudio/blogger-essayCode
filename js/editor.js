...
function loadcontentsStage2(){
    ...
    str=str+"</div>";
    str=str+"<div class=\"passagebutton\" onclick=\"newpassage()\"><p class=\"datetime\">新文章</p><p class=\"titlebutton\">点击创建文章</p></div>";
...
function newpassage(){
    pageinfo=document.getElementById("pageInfo");
    pageinfo.innerHTML="<a href=\"#\" onclick=\"loadcontents()\" class=\"back\"><i class=\"iconfont\">&#xe600;</i>返回</a>";
    passagelist=document.getElementById("passagelist");
    read=document.getElementById("read");
